...
export const mainNav: NavItem[] = [
  ...
  { label: "Nosotros", href: "/nosotros" },
  {
    ...
    children: [
      ...
      {
        label: "Boletín de Derechos Humanos",
        href: "/academia/boletin-derechos-humanos",
        description: "Reportes periódicos sobre la situación de DDHH en Colombia.",
      },
      {
        label: "Boletín de Prensa",
        href: "/academia/boletin-prensa",
        description: "Comunicados y posiciones oficiales de la fundación.",
      },
    ],
  },
